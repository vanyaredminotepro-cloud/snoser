...
- Фоновый backfill: бот проверяет последние посты источников за последние 8 дней (по умолчанию) и добирает пропущенные (если еще не публиковались).
...
- Медиа-посты (фото/видео/анимации) публикуются автоматически вместе с форматированным caption.
...
- Сокращение длинных новостей стало «умным»: сначала по границам предложений, затем по словам.
