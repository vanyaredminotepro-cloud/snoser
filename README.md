...
- В админ-панели доступны: «Хештеги (добавить/изменить)», «Организации/источники», «HTML исследование (beta)».
...
- В меню есть «Статистика стран»: если данных пока нет — показывается заглушка, иначе выводятся бюджет/армия/уровень жизни по странам.
...
- В анкете есть кнопки «Создать движение» и «Создать партию»; для владельцев уже зарегистрированной страны они блокируются.
